...
import com.cmpe295.university.model.UniversityInfo2List;
...
public class UniversityController {
	...
	UniversityInfo2List univList2 = new UniversityInfo2List();
...
// 	
    ...
    @RequestMapping(value = "/getAllUnivStates", method = RequestMethod.GET, produces = "application/json")
    public @ResponseBody UniversityInfoList  getState(Model model) 
    {
