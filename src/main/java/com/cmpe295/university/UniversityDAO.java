package com.cmpe295.university;
...
import com.cmpe295.university.model.UniversityInfo2;
...
public class UniversityDAO {
	...
	public List<UniversityInfo2> findAllUniversityInfo2(){
		...
		Session session = sessionFactory.getCurrentSession();
		List univ = session.createQuery(" from UniversityInfo2").list();
		return univ;
	}
	...
	public List<UniversityInfo> findUniversityInfoByName(String instName){
		...
		Session session = sessionFactory.getCurrentSession();
		List univ = session.createQuery(" from UniversityInfo where Instnm like'%"+instName+"%'").list();
		return univ;
	}
	@Transactional
	...
	public List<UnivProgram> findAdmissionInfoByUnivName(String instName){
		Session session = sessionFactory.getCurrentSession();
		List univ = session.createQuery("Select UP.UNITID,UP.ADMCON1, UP.ADMCON2, UP.ADMCON3, UP.ADMCON4, UP.ADMCON5, UP.ADMCON6, UP.ADMCON7, UP.ADMCON8, UP.ADMCON9 fom UniversityInfo UI,UnivProgram UP where UI.UNITID = UP.UNITID  AND UI.INSTNM like'%"+instName+"%'").list();
	...
	public List<UniversityInfo> findEnrollmentByUnivId(int univId){
		...
		Session session = sessionFactory.getCurrentSession();
		List univ = session.createQuery("Select UI.UNITID, UI.INSTNM, UP.ENRLT from UniversityInfo as UI, UnivPrograms as UP where UI.UNITID = UP.UNITID and UI.UNITID='"+univId+"'").list();
		return univ;
	...
	public List<UniversityInfo> findUniversityByApplication(int univId){
		...
		Session session = sessionFactory.getCurrentSession();
		List univ = session.createQuery("Select UI.UNITID,UI.INSTNM,UP.APPLCN from UniversityInfo as UI, UnivPrograms as UP where UI.UNITID = UP.UNITID and UI.UNITID="+univId).list();
		return univ;
	...
	public List<UniversityInfo> findUniversityByMingre(String gre){
		...
		Session session = sessionFactory.getCurrentSession();
		List univ = session.createQuery("Select UI.UNITID,UI.INSTNM,UP.MINGRE from UniversityInfo as UI, UnivPrograms as UP where UI.UNITID = UP.UNITID and UP.MINGRE <='"+gre+"'").list();
		return univ;
	...
	public List<UniversityInfo> findUniversityByMintoefl(String toefl){
		...
		Session session = sessionFactory.getCurrentSession();
		List univ = session.createQuery("Select UI.UNITID,UI.INSTNM,UP.MINTOEFL from UniversityInfo as UI, UnivPrograms as UP where UI.UNITID = UP.UNITID and UP.MINTOEFL <='"+toefl+"'").list();
		return univ;
	...
	public List<FinancialAid> findfinancialAidByUnivName(String instName){
		...
		Session session = sessionFactory.getCurrentSession();
		List univ = session.createQuery("Select FA.UNITID, FA.SCUGRAD, FA.SCUGFFN, FA.SCUGFFP, FA.SCFA2, FA.SCFA1N, FA.SCFA12N, FA.SCFA12P, FA.SCFA13N, FA.SCFA13P, FA.SCFY2, FA.SCFY1N, FA.UAGRNTN, FA.UAGRNTP, FA.UAGRNTT, FA.UAGRNTA, FA.GISTN2, FA.GISTON2, FA.GISTWF2, FA.GISTOF2, FA.GISTUN2, FA.GISTT2, FA.GISTA2 from UniversityInfo UI, FinancialAid FA where UI.UNITID = FA.UNITID  AND UI.INSTNM like'%"+instName+"%'").list();
		return univ;
	}
	...
	public List<UnivEnrollment> findEnrollCoursesByUnivName(String instName){
		...
		Session session = sessionFactory.getCurrentSession();
		List univ = session.createQuery("Select UE.UNITID, UE.EFCIPLEV, UE.CIPCODE, UE.ENROLLID FROM UniversityInfo UI, UnivEnrollment UE where  UI.UNITID = UE.UNITID AND Instnm like'%"+instName+"%'").list();
		return univ;
	}
